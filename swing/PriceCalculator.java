...
public class PriceCalculator extends JFrame {
	...
	public PriceCalculator() {
		...
		cmbModels = new JComboBox(new String[] { "Lenovo G Series", "HP Pavilion", "Dell Latitude" });
		...
		lblAmount.setOpaque(true); // background is visible
		...
		displayPrice(); // display price at the start
		setSize(300, 200);
